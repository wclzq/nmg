...
export default {
  ...
  data() {
    return {
      description:
        '可以查询治河工程运行状况；水库工程数据有水库控制水位、水库调度计划、水库防凌限制水位、防凌库容、上游水库下泄流量、下游水库的运用水位、引退水口的位置，分凌区运用状况，堤防工程运行状况等。同时在点击查询后，系统会在“防凌一张图”上显示宁蒙河段的主要治河工程、堤防工程、水库工程、分凌区的位置分布情况及主要属性信息。',
      // 高级搜索 展开/关闭
      advanced: false,
      data,
      flag: false,
