<template>
  <div>
    ...
    <a-card :bordered="true" hoverable  title="信息详情">
      ...
      <a-card type="inner" title="水文站上报数据">
        <detail-list title="详细数据" size="small">
          ...
          <detail-list-item term="岸冰情况">状态正常.</detail-list-item>
        </detail-list>
        ...
        <detail-list title="组名称" size="small" :col="2">
          <detail-list-item term="负责人">王超磊</detail-list-item>
...
export default {
  ...
  data() {
    return {
      description:
        '可查询当前流域防办最新“凌情值班报告”，水文站点上报的最新凌情数据，包括“流凌密度”、“水温数据”、“冰厚”、“封河数据”、“开河数据”、“凌峰数据”、“岸冰情况”等。',
      // 高级搜索 展开/关闭
      advanced: true,
      flag: false,
